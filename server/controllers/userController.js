...
// const isValidUelEmail = (email) => {
//   return /^[a-zA-Z0-9._%+-]+@iiti\.ac\.in$/.test(email.toLowerCase());
// };

// // const isValidUelEmail = (email) => {
// //   return /^[a-zA-Z0-9._%+-]+@uel\.ac\.uk$/.test(email.toLowerCase());
// // };
...
//     if (!isValidUelEmail(email)) {
//       return res
//         .status(400)
//         .json({ message: "Only @iiti.ac.in email addresses are allowed" });
//     }
...
const isValidIITIMail = (email) => /^[a-zA-Z0-9._%+-]+@iiti\.ac\.in$/.test(email.toLowerCase());
